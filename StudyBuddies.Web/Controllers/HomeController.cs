...
namespace StudyBuddies.Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            /*_userService.RegisterUser(new RegisterUserViewModel()
            {
                //Image = null,
                Password = "asd123secret",
                Email = "yeye@ye.ye",
                //Username = "Mesh",
                Name = "darko",
                Surname = "ela"
            ...
            //var locations = new List<LookupViewModel>();
            //_institutionService.CreateInstitution(new InstitutionViewModel()
            //{
            //    Name = "SEAVUS",
                
            //});
            var conversations = _userService.GetAllConversations(users.FirstOrDefault().Id);
            */
            //_userService.SendMessage(new MessageViewModel()
            //{
            //    UserFromId = users[1].Id,
            //    UserToId = users[0].Id,
            //    Content = "asdw2s"
            //});
            //_userService.AddFriend(users[1].Id, users[0].Id);
            //Seed();
        ...
        //    _Group grp = _userService.GetGroupsByName("OOP").First();
